...
const TAG_PATH    = 'otb_打标/tag_时尚休闲鞋.txt';
const OUTPUT_PATH = 'otb_打标/analyze_all_tags_时尚休闲鞋_report.md';
const TMP_DIR     = 'otb_打标/tmp_batch_reports_时尚休闲鞋';
const URL_COLUMN  = 'url';
const CATEGORY    = '时尚休闲鞋';
